...
export type { QuoteDocumentData, QuoteDocumentLine } from "@/lib/quote/quoteDocumentData";
    ...
    <div ref={pageRef} className="quote-page" style={{ transform: `scale(${scale})` }}>
      <aside className="brand-rail">
        ...
        <div className="rail-notice">
          ...
          <div className="rail-contact-row"><MapPin size={11} /><span>제이크이미지연구소<br />(정연호)</span></div>
        </div>
