    ...
    <main className={styles.workspace}>
      ...
      <div className={styles.editorGrid}>
        ...
        <section className={styles.center} aria-label="스토리 편집기">
          ...
          {activePage ? <ReviewStoryCanvas document={activePage.document} selectedElementId={selectedElementId} assetUrls={{ ...assetUrls, ...(activePage.assetUrls || {}) }} zoom={zoom} lockAspectRatio={lockAspectRatio} onSelect={setSelectedElementId} onChange={replaceActiveDocument} /> : <div className={styles.propertyEmpty} style={{ alignSelf: "center" }}><Sparkles size={28} /><br />왼쪽에서 후기를 선택하고<br />스토리를 자동 생성하세요.</div>}
        </section>
