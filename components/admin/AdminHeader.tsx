...
const pageMeta: Record<string, PageMeta> = {
  ...
  "/admin/crm": { title: "고객관리 CRM", description: "고객과 촬영 프로젝트의 진행 상태를 관리합니다." },
  "/admin/crm/dashboard": { title: "고객관리 CRM", description: "고객과 촬영 프로젝트의 진행 상태를 관리합니다." },
  "/admin/crm/clients": { title: "고객 목록", description: "고객 정보와 연결된 프로젝트를 확인합니다." },
  "/admin/crm/projects": { title: "프로젝트 목록", description: "전체 촬영 프로젝트와 진행 상태를 확인합니다." },
  "/admin/crm/board": { title: "프로젝트 보드", description: "프로젝트를 단계별 보드로 관리합니다." },
  "/admin/crm/workflows": { title: "프로젝트 워크플로우", description: "프로젝트별 작업 단계와 다음 액션을 관리합니다." },
  "/admin/crm/issues": { title: "지연 / 확인 필요", description: "조치가 필요한 프로젝트를 우선 확인합니다." },
  "/admin/crm/aftercare": { title: "후속 관리", description: "납품 이후 후기와 고객 후속 업무를 관리합니다." },
