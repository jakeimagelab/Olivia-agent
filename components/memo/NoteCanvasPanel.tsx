...
const SHAPE_OPTIONS: { key: DrawShape; label: string; icon: typeof Minus }[] = [
  { key: "line", label: "선", icon: Minus }, { key: "arrow", label: "화살표", icon: ArrowUpRight },
  { key: "rectangle", label: "사각형", icon: Square }, { key: "ellipse", label: "원", icon: Circle },
];
