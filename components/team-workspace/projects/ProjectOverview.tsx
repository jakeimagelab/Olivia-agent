...
export default function ProjectOverview({ projectId }: { projectId: string }) {
  ...
  return (
    <>
      ...
      <div style={{ height: 16 }} />
      <section className="team-card"><div className="team-card-header"><h3>메모</h3></div><div className="team-card-body" style={{ padding: 0 }}><Suspense fallback={<div className="team-empty">불러오는 중...</div>}><MemoWorkspace embedded contextType="project" contextId={projectId} /></Suspense></div></section>
      <div style={{ height: 16 }} />
