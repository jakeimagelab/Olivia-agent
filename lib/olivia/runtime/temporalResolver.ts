...
// 한 글자 요일 축약형(일/월/화/수/목/금/토)은 "일정"/"월급"처럼 흔한 단어의 첫 글자와 겹쳐
// 오탐 위험이 커서 이 패턴에서는 쓰지 않는다 — "다음주 요일"을 지정할 땐 전체 이름만 인정한다.
const WEEKDAY_GROUP = "일요일|월요일|화요일|수요일|목요일|금요일|토요일";
