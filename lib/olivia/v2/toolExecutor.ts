...
export const OLIVIA_V2_TOOLS: FunctionTool[] = [
  ...
  { type: "function", name: "find_photo_folder", description: "[READ] 사진 작업용 NAS 폴더, 백업 폴더, 촬영 폴더 또는 Workstation 프로젝트를 부분 이름으로 찾고 장수·용량·수정일·현재 처리 상태를 반환합니다. 원본 분리·RAW/JPG 분리·1차 분류·JPG 통합·씬별 분류·사진 분류·2차 분류 요청의 첫 단계로 사용합니다. 후보가 여러 개면 반드시 사용자에게 어느 폴더인지 물어보세요.", strict: true, parameters: { type: "object", additionalProperties: false, properties: { query: { type: "string" } }, required: ["query"] } },
