...
export const OLIVIA_V2_TOOLS: FunctionTool[] = [
  ...
  { type: "function", name: "nas_backup_start_sort", description: "[WRITE] NAS에 감지된 폴더의 기존 PHOTO_SORT 분류 작업을 시작합니다. department(진료과)와 shootingMode(field 또는 studio)는 절대 추측하지 않으므로 대화에 없으면 반드시 사용자에게 물어보세요.", strict: true, parameters: { type: "object", additionalProperties: false, properties: { folderName: { type: "string" }, department: { type: "string" }, shootingMode: { type: "string", enum: ["field", "studio"] }, gapMinutes: { type: ["number", "null"] }, eventId: { type: ["string", "null"] } }, required: ["folderName", "department", "shootingMode", "gapMinutes", "eventId"] } },
];
