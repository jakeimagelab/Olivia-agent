...
JSON 형식으로만 응답하세요:
{
  ...
  sceneTypes: [
    ...
    },
    {
      ...
      displayName: "원장상담",
      folderName: "03_원장상담",
      description: "흰 가운 의사와 고객이 마주 앉아 상담하는 장면 — 고객이 의자에 앉아 있고 핸드피스/장비 사용 없음",
      priority: 5,
      visualCues: ["흰 가운", "의사", "고객이 의자에 앉음", "앉아서 상담", "책상", "모니터", "차트", "피부모형", "설명하는 자세"],
      requiredCues: [],
    ...
    },
    {
      ...
      displayName: "프로필",
      folderName: "07_프로필",
      description: "촬영자가 연출한 1인 정지 포즈 프로필 사진 — 정면 응시, 팔짱/손깍지/손모음 포즈, 단독 구도",
      priority: 7,
      visualCues: ["정면 응시", "1인 단독", "정지 포즈", "팔짱", "손깍지", "손모음", "단순 배경", "로고 배경", "의도된 연출"],
      negativeCues: ["환자와 함께", "2인 이상", "환자에게 설명 중", "시술 중", "치료 중", "상담 중", "장비 사용", "핸드피스", "주사기", "차트", "펜", "거울 들고 있음", "환자 피부 만지는 중"],
    },
    {
      sceneType: "interior",
      displayName: "인테리어",
