...
export const TOOLS_WORK: ToolDef[] = [
  ...
  { title: "음성 기록", desc: "미팅을 녹음하고 화자를 구분해 내용을 자동 정리합니다.", href: "/voice-recorder", icon: Mic, meta: "Olivia Recorder", orange: false, category: "dashboard", aliases: ["녹음", "음성녹음", "음성 녹음", "음성 기록", "음성기록", "음성메모", "음성 메모", "미팅 녹음", "회의 녹음", "녹음기", "레코더"] },
  ...
  { title: "콘티", desc: "진료과와 촬영 항목을 선택해 병원 촬영 콘티를 자동 생성합니다.", href: "/conti", icon: FileVideo, meta: "Storyboard", orange: false, category: "tools", aliases: ["콘티", "촬영 콘티", "콘티 만들기", "촬영계획", "촬영 계획"] },
  { title: "초상권 동의서", desc: "촬영 대상자의 사진·영상 촬영 및 활용 동의서를 작성하고 서명을 받습니다.", href: "/portrait-consent", icon: FileSignature, meta: "Portrait Consent", orange: false, category: "tools", aliases: ["초상권", "초상권 동의서", "촬영 동의서", "사진 동의서", "영상 동의서"] },
