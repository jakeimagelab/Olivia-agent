...
// 필드를 만들지 않고 이 값을 리뷰 관리 화면의 4단계 표시(미제작/제작중/제작완료/보류)로만 매핑한다.
// 'excluded'는 다른 3단계 어디에도 안 쓰이던 값이라 "보류"로 재사용한다.
export type ReviewContentStage = "not_created" | "in_progress" | "on_hold" | "completed";
...
export const REVIEW_CONTENT_STAGE_COLOR: Record<ReviewContentStage, { text: string; bg: string }> = {
  not_created: { text: "#B4690E", bg: "#FFF3E0" },
  in_progress: { text: "#946F00", bg: "#FFFAE0" },
  on_hold: { text: "#6B807C", bg: "#F0F3F2" },
