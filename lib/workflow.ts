...
export const WORKFLOW_STEPS = [
  {
    ...
    stage: "consult_contract" as WorkflowStageKey, primary: true, display_order: 1,
  },
  {
    ...
    stage: "consult_contract" as WorkflowStageKey, primary: true, display_order: 2,
  },
  {
    ...
    stage: "consult_contract" as WorkflowStageKey, primary: true, display_order: 3,
  },
  {
    ...
    stage: "prep_shooting" as WorkflowStageKey, primary: true, display_order: 4,
  },
  {
    key: "shooting",          name: "촬영",
    order_index: 5,  requires_approval: false, automation_level: "manual" as const,
    visible_to_client: false, creates_mailing_draft: false, related_feature: "clients",
    stage: "prep_shooting" as WorkflowStageKey, primary: true, display_order: 5,
  },
  {
    ...
    stage: "data_sharing" as WorkflowStageKey, primary: true, display_order: 7,
  },
  {
...
export const MOCK_WORKFLOW_RUNS = [
  {
    ...
    current_step_key: "conti",
    current_step_name: "콘티 작성 / 전달",
    next_action: "콘티 초안 승인 후 발송",
    manager_name: "표진규원장님",
  ...
  },
  {
    ...
    current_step_key: "shooting",
    current_step_name: "촬영",
    next_action: "촬영 완료 후 백업 분류 단계로 전진",
    manager_name: "박실장님",
...
export const MOCK_AGENT_TASKS = [
  {
    id: "task-sample-1",
    title: "운정표병원 최종파일 전달 메일 생성",
    description: "NAS 링크와 후기 요청 폼을 포함한 최종파일 전달 메일 초안을 생성합니다.",
    client_name: "운정표병원",
    project_name: "브랜드 촬영 4월",
    workflow_step_key: "final_delivery",
    workflow_step_name: "최종파일 전달 + 후기 요청",
    task_type: "mailing_draft_created",
    priority: "urgent",
    status: "waiting_approval",
    input_data: { nasLink: "NAS 공유 링크", sendTo: "pedpyo1@naver.com" },
    output_data: { subject: "[포토클리닉] 운정표병원 최종 촬영본 공유" },
    created_at: new Date().toISOString(),
    started_at: null,
    completed_at: null,
  },
  {
    ...
    client_name: "브라보마취통증의학과",
    project_name: "프리미엄패키지",
    workflow_step_key: "quote",
    workflow_step_name: "견적서 생성 / 전달",
  ...
  {
    id: "task-sample-3",
    title: "라셀의원 원본 데이터 자동 전달",
    description: "NAS 공유링크를 생성하고 원본 데이터 전달 메일을 자동 발송합니다.",
    client_name: "라셀의원",
    project_name: "SNS 구독 운영",
    workflow_step_key: "original_delivery",
    workflow_step_name: "원본 데이터 전달",
