...
import type {
  ...
  DiagnosisSource, HistoryItem, HospitalBrandDiagnosisReport, SourceStatus, UploadedAsset, VideoAnalysisSummary, VisualCategory,
...
/* ─────────────────────────── 메인 위저드 ─────────────────────────── */
/* STEP7 결과 리포트(ReportView)는 components/hospital-brand-diagnosis/ReportView.tsx로 분리되어
   공유(shared/[token]) 페이지에서도 재사용된다 — page.tsx가 아닌 별도 파일인 이유는, Next.js가
   page.tsx에서 default export 외의 이름 있는 export를 허용하지 않기 때문이다. */
