  ...
  return <div className="channel-native-page">
    ...
    {tab === "history" ? <main className="channel-native-main">
      ...
      {result && <article className="channel-report" ref={reportRef}>
        <header className="channel-report-cover"><div><h2>{hospitalName || "분석 대상 병원"}</h2><p>{specialty}{specialty && " · "}{result.coverage_summary}</p></div><div className={`channel-score ${scoreTone}`}><strong>{result.overall_score}</strong><span>/100</span></div></header>
