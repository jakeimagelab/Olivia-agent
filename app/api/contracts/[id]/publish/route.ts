...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    // 워크플로우 전진의 주 트리거는 이제 "최종완료"(app/api/workflow-runs/[id]/complete-step,
    ...
    await completeOpenStepTasksForManualSave(db, workflowRunId, "contract").catch(() => {});
    await maybeAdvanceWorkflow(db, workflowRunId, "contract").catch((err) => {
