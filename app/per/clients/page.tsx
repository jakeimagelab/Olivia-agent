      ...
      <div style={{ background:C.teal, color:"#fff", padding:"20px 24px 18px" }}>
        <div style={{ maxWidth:920, margin:"0 auto", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <div>
            ...
            <h1 style={{ margin:"4px 0 0", fontSize:20, fontWeight:800 }}>병원별 포인트 관리</h1>
          </div>
          <button onClick={() => setAddModal(true)} style={{ background:C.orange, color:"#fff", border:"none", borderRadius:8, padding:"9px 16px", fontWeight:700, fontSize:13, cursor:"pointer", display:"flex", alignItems:"center", gap:6 }}>
            <Plus size={15}/> 포인트 적립
          </button>
        </div>
      </div>

      <div style={{ maxWidth:920, margin:"0 auto", padding:"20px 16px 0" }}>
