      ...
      <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 16, overflow: "hidden" }}>
        ...
        <div style={{ padding: 20, display: "grid", gap: 12 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 10 }}>
            <label className="field"><span>클라이언트명 *</span><input style={inputStyle} value={form.hospitalName} onChange={e => set("hospitalName", e.target.value)} placeholder="온유성형외과" /></label>
  ...
  return (
    <main style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Noto Sans KR', sans-serif", color: C.txt }}>
      ...
      <nav style={{ background: C.surface, borderBottom: `1px solid ${C.border}`, display: "flex", overflowX: "auto" }}>
        ...
        <Link href="/review-studio" style={{ padding: "11px 22px", fontSize: 13, fontWeight: 700, whiteSpace: "nowrap", color: C.teal, borderBottom: `2px solid ${C.teal}`, textDecoration: "none", display: "inline-block" }}>⭐ 후기 콘텐츠</Link>
        <Link href="/per"           style={{ padding: "11px 22px", fontSize: 13, fontWeight: 700, whiteSpace: "nowrap", color: C.muted, borderBottom: "2px solid transparent", textDecoration: "none", display: "inline-block" }}>🏆 PER 리워드</Link>
      </nav>
